...
open class HLSCachingReverseProxyServer {
    ...
    public init(webServer: GCDWebServer? = nil, urlSession: URLSession? = nil, cache: PINCaching? = nil, options: String? = nil) {
        self.webServer = webServer ?? GCDWebServer()
